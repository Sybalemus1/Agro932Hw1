...
## simulate 10 individals population 1

```{bash, eval=FALSE}
for i in {1..10}; do    wgsim Zea_mays.B73_RefGen_v4.dna.chromosome.Mt.fa -e 0 -d 500 -N 50000 -1 100 -2 100 -r 0.1  -R 0 -X 0 p1l$i.read1.fq l$i.read2.fq; done
mv l1.read1.fq p1l1.read1.fq #(Change name pop 1. all 10 idividuals)

```
## simulate 10 individals population 2
...
mv l1.read1.fq p2l1.read1.fq #(Change name pop 2. all 10 idividuals)
...
hist(theta$Watterson, col="blue", xlab="Theta pairwise values (log10)") 
hist(theta$thetaSingleton, col="grey", xlab="Theta pairwise values (log10)") 
hist(theta$thetaH, col="red", xlab="Theta pairwise values (log10)") 
```
